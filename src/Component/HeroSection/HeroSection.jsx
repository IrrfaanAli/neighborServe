...
export const HeroSection = () => {
  return (
     ...
     <div className='flex flex-col lg:flex-row lg:gap-60 '>
         ...
         <h1 className="text-lg lg:text-3xl lg:text-right font-semibold leading-loose lg:mb-5  lg:mr-[200px]  ">Your <span className='text-primary font-bold text-xl lg:text-4xl'>One-Stop</span> Solution for Every Home Service ,
         We Offer <span  className='text-primary font-bold text-xl lg:text-4xl'> Electrical</span> Service 
         </h1>
         <div className='lg:mx-[150px] '>
         <input type="text" placeholder="Search for exparts" className=" input input-bordered  rounded-l rounded-r-none shadow-xl border-r-0  lg:h-[54.5px]  input-primary w-48 lg:w-full max-w-xs" />
         <button className='bg-primary lg:h-[55px] px-3 lg:px-5 py-3 lg:py-4 mt-3  text-white rounded-l-none rounded-r '>Search</button>
         ...
         <p className=' text-center lg:mr-[190px] lg:text-right lg:mt-4 lg:text-2xl'>Your <span className='text-primary'>Neighborhood</span>,Your <span className='text-primary'>Services</span> <br></br>
